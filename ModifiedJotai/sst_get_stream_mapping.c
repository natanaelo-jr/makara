...
sst_get_stream_mapping(int dev, int sdev, int dir,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_map0 = 65025;
    struct sst_dev_stream_map *map = (struct sst_dev_stream_map *)malloc(
        _len_map0 * sizeof(struct sst_dev_stream_map));
    ...
    int benchRet = ({
      ...
      __typeof__(sst_get_stream_mapping(dev, sdev, dir, map, size)) __perf_ret =
          sst_get_stream_mapping(dev, sdev, dir, map, size);
      ...
      // Write data
      fprintf(f_csv, "sst_get_stream_mapping,%lu,%lu,%lu,%lu newline",
