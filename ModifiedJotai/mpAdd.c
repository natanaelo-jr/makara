...
__attribute__((used)) static DIGIT_T mpAdd(DIGIT_T *w, DIGIT_T *u, DIGIT_T *v,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(mpAdd(w, u, v, ndigits)) __perf_ret = mpAdd(w, u, v, ndigits);
      ...
      // Write data
      fprintf(f_csv, "mpAdd,%lu,%lu,%lu,%lu newline", count_cycles,
