...
has_channel(struct rt_channel_info *channel_set, u8 chanset_size, u8 chan) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct rt_channel_info *channel_set = (struct rt_channel_info *)malloc(
        _len_channel_set0 * sizeof(struct rt_channel_info));
    ...
    int benchRet = ({
      ...
      __typeof__(has_channel(channel_set, chanset_size, chan)) __perf_ret =
          has_channel(channel_set, chanset_size, chan);
      ...
      // Write data
      fprintf(f_csv, "has_channel,%lu,%lu,%lu,%lu newline", count_cycles,
