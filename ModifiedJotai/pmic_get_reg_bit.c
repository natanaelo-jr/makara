...
__attribute__((used)) static int pmic_get_reg_bit(int address,
                                                  struct pmic_table *table,
                                                  int count, int *reg,
                                                  int *bit) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct pmic_table *table =
        (struct pmic_table *)malloc(_len_table0 * sizeof(struct pmic_table));
    ...
    int benchRet = ({
      ...
      __typeof__(pmic_get_reg_bit(address, table, count, reg, bit)) __perf_ret =
          pmic_get_reg_bit(address, table, count, reg, bit);
      ...
      // Write data
      fprintf(f_csv, "pmic_get_reg_bit,%lu,%lu,%lu,%lu newline", count_cycles,
