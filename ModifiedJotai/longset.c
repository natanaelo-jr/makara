...
__attribute__((used)) static unsigned long *longset(unsigned long *s,
                                                    unsigned long c, size_t n) {
  size_t i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long *benchRet = ({
      ...
      __typeof__(longset(s, c, n)) __perf_ret = longset(s, c, n);
      ...
      // Write data
      fprintf(f_csv, "longset,%lu,%lu,%lu,%lu newline", count_cycles,
