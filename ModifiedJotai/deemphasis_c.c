...
__attribute__((used)) static float deemphasis_c(float *y, float *x, float coeff,
                                                int len) {
  float state = coeff;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    float benchRet = ({
      ...
      __typeof__(deemphasis_c(y, x, coeff, len)) __perf_ret =
          deemphasis_c(y, x, coeff, len);
      ...
      // Write data
      fprintf(f_csv, "deemphasis_c,%lu,%lu,%lu,%lu newline", count_cycles,
