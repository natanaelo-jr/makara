...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(ExtractName(pBuffer, pOutput, Offset, Limit)) __perf_ret =
          ExtractName(pBuffer, pOutput, Offset, Limit);
      ...
      // Write data
      fprintf(f_csv, "ExtractName,%lu,%lu,%lu,%lu newline", count_cycles,
