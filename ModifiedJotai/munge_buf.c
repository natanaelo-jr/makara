...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_src0 = 65025;
    unsigned char *src =
        (unsigned char *)malloc(_len_src0 * sizeof(unsigned char));
    ...
    unsigned char *benchRet = ({
      ...
      __typeof__(munge_buf(src, dst, dst_size)) __perf_ret =
          munge_buf(src, dst, dst_size);
      ...
      // Write data
      fprintf(f_csv, "munge_buf,%lu,%lu,%lu,%lu newline", count_cycles,
