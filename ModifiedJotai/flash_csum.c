...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct qib_flash *ifp =
        (struct qib_flash *)malloc(_len_ifp0 * sizeof(struct qib_flash));
    ...
    int benchRet = ({
      ...
      __typeof__(flash_csum(ifp, adjust)) __perf_ret = flash_csum(ifp, adjust);
      ...
      // Write data
      fprintf(f_csv, "flash_csum,%lu,%lu,%lu,%lu newline", count_cycles,
