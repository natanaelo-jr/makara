...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(util_memsearch(buf, buf_len, mem, mem_len)) __perf_ret =
          util_memsearch(buf, buf_len, mem, mem_len);
      ...
      // Write data
      fprintf(f_csv, "util_memsearch,%lu,%lu,%lu,%lu newline", count_cycles,
