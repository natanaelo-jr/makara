...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(i40iw_get_encoded_wqe_size(wqsize,cqpsq)) __perf_ret = i40iw_get_encoded_wqe_size(wqsize,cqpsq);
    ...
    // Write data
    fprintf(f_csv, "i40iw_get_encoded_wqe_size,%lu,%lu,%lu,%lu newline",
            count_cycles,
            count_instructions,
            count_cache_miss,
            count_cache_ref);
