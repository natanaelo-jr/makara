...
is_desired_ep11_card(unsigned int dev_id, unsigned short target_num,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct ep11_target_dev *targets = (struct ep11_target_dev *)malloc(
        _len_targets0 * sizeof(struct ep11_target_dev));
    ...
    int benchRet = ({
      ...
      __typeof__(is_desired_ep11_card(dev_id, target_num, targets)) __perf_ret =
          is_desired_ep11_card(dev_id, target_num, targets);
      ...
      // Write data
      fprintf(f_csv, "is_desired_ep11_card,%lu,%lu,%lu,%lu newline",
