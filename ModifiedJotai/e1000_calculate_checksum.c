...
__attribute__((used)) static u8 e1000_calculate_checksum(u8 *buffer,
                                                         u32 length) {
  u32 i;
  u8 sum = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(e1000_calculate_checksum(buffer, length)) __perf_ret =
          e1000_calculate_checksum(buffer, length);
      ...
      // Write data
      fprintf(f_csv, "e1000_calculate_checksum,%lu,%lu,%lu,%lu newline",
