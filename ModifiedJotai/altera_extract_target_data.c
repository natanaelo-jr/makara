...
altera_extract_target_data(u8 *buffer, u8 *target_data, u32 start_index,
                           u32 preamble_count, u32 target_count)
/*
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      altera_extract_target_data(buffer, target_data, start_index,
                                 preamble_count, target_count);
      ...
      // Write data
      fprintf(f_csv, "altera_extract_target_data,%lu,%lu,%lu,%lu newline",
