...
void i40e_fill_rss_lut(struct i40e_pf *pf, u8 *lut, u16 rss_table_size,
                       u16 rss_size) {
  u16 i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_pf0 = 65025;
    struct i40e_pf *pf =
        (struct i40e_pf *)malloc(_len_pf0 * sizeof(struct i40e_pf));
    ...
    int _len_lut0 = 65025;
    unsigned long *lut =
        (unsigned long *)malloc(_len_lut0 * sizeof(unsigned long));
...

    {
      ...
      // Write data
      fprintf(f_csv, "i40e_fill_rss_lut,%lu,%lu,%lu,%lu newline", count_cycles,
