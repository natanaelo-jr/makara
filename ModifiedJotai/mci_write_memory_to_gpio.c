...
__attribute__((used)) static void mci_write_memory_to_gpio(struct cx231xx *dev,
                                                           u32 address,
                                                           u32 value,
                                                           u32 *p_fw_image) {
  u32 temp = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_dev0 = 65025;
    struct cx231xx *dev =
        (struct cx231xx *)malloc(_len_dev0 * sizeof(struct cx231xx));
...

    {
      ...
      // Write data
      fprintf(f_csv, "mci_write_memory_to_gpio,%lu,%lu,%lu,%lu newline",
