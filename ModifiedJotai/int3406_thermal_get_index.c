...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(int3406_thermal_get_index(array,nr,value)) __perf_ret = int3406_thermal_get_index(array,nr,value);
    ...
    // Write data
    fprintf(f_csv, "int3406_thermal_get_index,%lu,%lu,%lu,%lu newline",
            count_cycles,
            count_instructions,
            count_cache_miss,
            count_cache_ref);
