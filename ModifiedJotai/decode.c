...
__attribute__((used)) static unsigned long decode(unsigned long *data,
                                                  unsigned long *raw, int len) {
  ulong *odd, *even;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long *data =
        (unsigned long *)malloc(_len_data0 * sizeof(unsigned long));
    ...
    int _len_raw0 = 65025;
    unsigned long *raw =
        (unsigned long *)malloc(_len_raw0 * sizeof(unsigned long));
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(decode(data, raw, len)) __perf_ret = decode(data, raw, len);
      ...
      // Write data
      fprintf(f_csv, "decode,%lu,%lu,%lu,%lu newline", count_cycles,
