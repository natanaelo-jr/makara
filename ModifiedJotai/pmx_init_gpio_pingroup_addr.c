...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct spear_gpio_pingroup *gpio_pingroup =
        (struct spear_gpio_pingroup *)malloc(
            _len_gpio_pingroup0 * sizeof(struct spear_gpio_pingroup));
    for (int _i0 = 0; _i0 < _len_gpio_pingroup0; _i0++) {
      ...
      gpio_pingroup[_i0].muxregs = (struct TYPE_2__ *)malloc(
          _len_gpio_pingroup__i0__muxregs0 * sizeof(struct TYPE_2__));
      for (int _j0 = 0; _j0 < _len_gpio_pingroup__i0__muxregs0; _j0++) {
        gpio_pingroup[_i0].muxregs->reg =
            ((-2 * (next_i() % 2)) + 1) * next_i();
      }
    }

    {
      ...
      // Write data
      fprintf(f_csv, "pmx_init_gpio_pingroup_addr,%lu,%lu,%lu,%lu newline",
