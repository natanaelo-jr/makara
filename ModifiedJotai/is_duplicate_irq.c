...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(is_duplicate_irq(irq, irqs, nr_irqs)) __perf_ret =
          is_duplicate_irq(irq, irqs, nr_irqs);
      ...
      // Write data
      fprintf(f_csv, "is_duplicate_irq,%lu,%lu,%lu,%lu newline", count_cycles,
