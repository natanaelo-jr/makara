...
__attribute__((used)) static int mpCompare(DIGIT_T *a, DIGIT_T *b,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(mpCompare(a, b, ndigits)) __perf_ret =
          mpCompare(a, b, ndigits);
      ...
      // Write data
      fprintf(f_csv, "mpCompare,%lu,%lu,%lu,%lu newline", count_cycles,
