...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct perf_event **slot =
        (struct perf_event **)malloc(_len_slot0 * sizeof(struct perf_event *));
    for (int _i0 = 0; _i0 < _len_slot0; _i0++) {
      int _len_slot1 = 1;
      slot[_i0] =
          (struct perf_event *)malloc(_len_slot1 * sizeof(struct perf_event));
    ...
    int _len_bp0 = 65025;
    struct perf_event *bp =
        (struct perf_event *)malloc(_len_bp0 * sizeof(struct perf_event));
    ...
    int benchRet = ({
      ...
      __typeof__(alloc_slot(slot, n, bp)) __perf_ret = alloc_slot(slot, n, bp);
      ...
      // Write data
      fprintf(f_csv, "alloc_slot,%lu,%lu,%lu,%lu newline", count_cycles,
