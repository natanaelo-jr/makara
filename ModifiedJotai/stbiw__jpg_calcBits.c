...
__attribute__((used)) static void stbiw__jpg_calcBits(int val,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_bits0 = 2;
    unsigned short *bits =
        (unsigned short *)malloc(_len_bits0 * sizeof(unsigned short));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "stbiw__jpg_calcBits,%lu,%lu,%lu,%lu newline",
