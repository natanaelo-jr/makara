...
__attribute__((used)) static int match_ipv6_addrmask(u32 *input, u32 *addr,
                                                     u32 *mask) {
  int i, fail = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(match_ipv6_addrmask(input, addr, mask)) __perf_ret =
          match_ipv6_addrmask(input, addr, mask);
      ...
      // Write data
      fprintf(f_csv, "match_ipv6_addrmask,%lu,%lu,%lu,%lu newline",
