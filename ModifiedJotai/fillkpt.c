...
__attribute__((used)) static void fillkpt(pt_entry_t *base, int prot,
                                          uintptr_t src, int index, int count) {
  int i;
  for (i = 0; i < count; i++) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_base0 = 100;
    unsigned long *base =
        (unsigned long *)malloc(_len_base0 * sizeof(unsigned long));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "fillkpt,%lu,%lu,%lu,%lu newline", count_cycles,
