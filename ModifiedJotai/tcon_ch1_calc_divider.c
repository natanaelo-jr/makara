...
tcon_ch1_calc_divider(unsigned long rate, unsigned long parent_rate, u8 *div,
                      bool *half) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(tcon_ch1_calc_divider(rate, parent_rate, div,
                                       half)) __perf_ret =
          tcon_ch1_calc_divider(rate, parent_rate, div, half);
      ...
      // Write data
      fprintf(f_csv, "tcon_ch1_calc_divider,%lu,%lu,%lu,%lu newline",
