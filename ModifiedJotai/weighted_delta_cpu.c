...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      // Write data
      fprintf(f_csv, "weighted_delta_cpu,%lu,%lu,%lu,%lu newline", count_cycles,
