...
imc_adjust_bit_allocation(IMCContext *q, IMCChannel *chctx, int summer) {
  float workT[32];
  int corrected = 0;
  int i, j;
  float highest = 0;
  ...
  while (corrected < summer) {
    ...
    if (highest > -1.e20) {
      ...
      for (j = band_tab[found_indx];
           j < band_tab[found_indx + 1] && (corrected < summer); j++) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_chctx0 = 1;
    struct TYPE_3__ *chctx =
        (struct TYPE_3__ *)malloc(_len_chctx0 * sizeof(struct TYPE_3__));
    for (int _i0 = 0; _i0 < _len_chctx0; _i0++) {
      int _len_chctx__i0__bitsBandT0 = 1;
      chctx[_i0].bitsBandT =
          (int *)malloc(_len_chctx__i0__bitsBandT0 * sizeof(int));
      ...
      chctx[_i0].flcoeffs4 =
          (int *)malloc(_len_chctx__i0__flcoeffs40 * sizeof(int));
      ...
      chctx[_i0].CWlengthT =
          (int *)malloc(_len_chctx__i0__CWlengthT0 * sizeof(int));
      ...
      chctx[_i0].skipFlags =
          (int *)malloc(_len_chctx__i0__skipFlags0 * sizeof(int));
...

    {
      ...
      // Write data
      fprintf(f_csv, "imc_adjust_bit_allocation,%lu,%lu,%lu,%lu newline",
