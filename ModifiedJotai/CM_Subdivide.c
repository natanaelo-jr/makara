...
__attribute__((used)) static void CM_Subdivide(vec3_t a, vec3_t b, vec3_t c,
                                               vec3_t out1, vec3_t out2,
                                               vec3_t out3) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      // Write data
      fprintf(f_csv, "CM_Subdivide,%lu,%lu,%lu,%lu newline", count_cycles,
