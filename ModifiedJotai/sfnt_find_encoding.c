...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(sfnt_find_encoding(platform_id, encoding_id)) __perf_ret =
          sfnt_find_encoding(platform_id, encoding_id);
      ...
      // Write data
      fprintf(f_csv, "sfnt_find_encoding,%lu,%lu,%lu,%lu newline", count_cycles,
