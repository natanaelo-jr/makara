...
mul_poly(unsigned int a, unsigned int b, unsigned int poly) {
  unsigned int c;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned int benchRet = ({
      ...
      __typeof__(mul_poly(a, b, poly)) __perf_ret = mul_poly(a, b, poly);
      ...
      // Write data
      fprintf(f_csv, "mul_poly,%lu,%lu,%lu,%lu newline", count_cycles,
