...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_spds0 = 100;
    unsigned short *spds =
        (unsigned short *)malloc(_len_spds0 * sizeof(unsigned short));
    for (int _i0 = 0; _i0 < _len_spds0; _i0++) {
      spds[_i0] = ((-2 * (next_i() % 2)) + 1) * next_i();
    }
    unsigned short benchRet = ({
      ...
      __typeof__(calc_speed(spds, num, dflt)) __perf_ret =
          calc_speed(spds, num, dflt);
      ...
      // Write data
      fprintf(f_csv, "calc_speed,%lu,%lu,%lu,%lu newline", count_cycles,
