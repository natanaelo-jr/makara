...
__attribute__((used)) static char *dn_find_slot(char *base, int max,
                                                int priority) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *benchRet = ({
      ...
      __typeof__(dn_find_slot(base, max, priority)) __perf_ret =
          dn_find_slot(base, max, priority);
      ...
      // Write data
      fprintf(f_csv, "dn_find_slot,%lu,%lu,%lu,%lu newline", count_cycles,
