...
__attribute__((used)) static unsigned char ipmb_checksum(unsigned char *data,
                                                         int size) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned char benchRet = ({
      ...
      __typeof__(ipmb_checksum(data, size)) __perf_ret =
          ipmb_checksum(data, size);
      ...
      // Write data
      fprintf(f_csv, "ipmb_checksum,%lu,%lu,%lu,%lu newline", count_cycles,
