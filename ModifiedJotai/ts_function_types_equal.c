...
bool ts_function_types_equal(Oid left[], Oid right[], int nargs) {
  int arg_index;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(ts_function_types_equal(left, right, nargs)) __perf_ret =
          ts_function_types_equal(left, right, nargs);
      ...
      // Write data
      fprintf(f_csv, "ts_function_types_equal,%lu,%lu,%lu,%lu newline",
