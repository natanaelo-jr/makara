...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(get_resource(rscs, amount, multi, ridx)) __perf_ret =
          get_resource(rscs, amount, multi, ridx);
      ...
      // Write data
      fprintf(f_csv, "get_resource,%lu,%lu,%lu,%lu newline", count_cycles,
