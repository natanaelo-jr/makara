...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(set_prescale_div(rqst_prescaler, prescale_div,
                                  tb_clk_div)) __perf_ret =
          set_prescale_div(rqst_prescaler, prescale_div, tb_clk_div);
      ...
      // Write data
      fprintf(f_csv, "set_prescale_div,%lu,%lu,%lu,%lu newline", count_cycles,
