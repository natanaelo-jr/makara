...
__attribute__((used)) static int huff_smallest_node(hnode *hnodes,
                                                    int num_hnodes) {
  int i;
  int best, best_node;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_3__ *hnodes =
        (struct TYPE_3__ *)malloc(_len_hnodes0 * sizeof(struct TYPE_3__));
    ...
    int benchRet = ({
      ...
      __typeof__(huff_smallest_node(hnodes, num_hnodes)) __perf_ret =
          huff_smallest_node(hnodes, num_hnodes);
      ...
      // Write data
      fprintf(f_csv, "huff_smallest_node,%lu,%lu,%lu,%lu newline", count_cycles,
