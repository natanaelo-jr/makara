...
struct fm10k_hw_stats_q {
  scalar_t__ tx_stats_idx;
  scalar_t__ rx_stats_idx;
};
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_q0 = 65025;
    struct fm10k_hw_stats_q *q = (struct fm10k_hw_stats_q *)malloc(
        _len_q0 * sizeof(struct fm10k_hw_stats_q));
...

    {
      ...
      // Write data
      fprintf(f_csv, "fm10k_unbind_hw_stats_q,%lu,%lu,%lu,%lu newline",
