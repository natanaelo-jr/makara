...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(ieee80211_crypto_cs_pn_compare(pn1,pn2,len)) __perf_ret = ieee80211_crypto_cs_pn_compare(pn1,pn2,len);
    ...
    // Write data
    fprintf(f_csv, "ieee80211_crypto_cs_pn_compare,%lu,%lu,%lu,%lu newline",
            count_cycles,
            count_instructions,
            count_cache_miss,
            count_cache_ref);
