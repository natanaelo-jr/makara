...
__attribute__((used)) static size_t get_end_of_cookie_value(char *cookie,
                                                            size_t cookie_len) {
  size_t i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(get_end_of_cookie_value(cookie, cookie_len)) __perf_ret =
          get_end_of_cookie_value(cookie, cookie_len);
      ...
      // Write data
      fprintf(f_csv, "get_end_of_cookie_value,%lu,%lu,%lu,%lu newline",
