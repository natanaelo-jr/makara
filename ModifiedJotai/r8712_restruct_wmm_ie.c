...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct _adapter *adapter =
        (struct _adapter *)malloc(_len_adapter0 * sizeof(struct _adapter));
    ...
    int benchRet = ({
      ...
      __typeof__(r8712_restruct_wmm_ie(adapter, in_ie, out_ie, in_len,
                                       initial_out_len)) __perf_ret =
          r8712_restruct_wmm_ie(adapter, in_ie, out_ie, in_len,
                                initial_out_len);
      ...
      // Write data
      fprintf(f_csv, "r8712_restruct_wmm_ie,%lu,%lu,%lu,%lu newline",
