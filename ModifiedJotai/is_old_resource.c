...
is_old_resource(struct resource *res, struct resource **list, int n) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_res0 = 65025;
    struct resource *res =
        (struct resource *)malloc(_len_res0 * sizeof(struct resource));
    ...
    struct resource **list =
        (struct resource **)malloc(_len_list0 * sizeof(struct resource *));
    for (int _i0 = 0; _i0 < _len_list0; _i0++) {
      int _len_list1 = 1;
      list[_i0] =
          (struct resource *)malloc(_len_list1 * sizeof(struct resource));
    ...
    int benchRet = ({
      ...
      __typeof__(is_old_resource(res, list, n)) __perf_ret =
          is_old_resource(res, list, n);
      ...
      // Write data
      fprintf(f_csv, "is_old_resource,%lu,%lu,%lu,%lu newline", count_cycles,
