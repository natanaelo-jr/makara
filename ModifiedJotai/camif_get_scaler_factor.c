...
camif_get_scaler_factor(u32 src, u32 tar, u32 *ratio, u32 *shift) {
  unsigned int sh = 6;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(camif_get_scaler_factor(src, tar, ratio, shift)) __perf_ret =
          camif_get_scaler_factor(src, tar, ratio, shift);
      ...
      // Write data
      fprintf(f_csv, "camif_get_scaler_factor,%lu,%lu,%lu,%lu newline",
