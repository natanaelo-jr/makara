...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_val0 = 65025;
    unsigned char *val =
        (unsigned char *)malloc(_len_val0 * sizeof(unsigned char));
    ...
    char *benchRet = ({
      ...
      __typeof__(read_run_data(run, nn, val, sig)) __perf_ret =
          read_run_data(run, nn, val, sig);
      ...
      // Write data
      fprintf(f_csv, "read_run_data,%lu,%lu,%lu,%lu newline", count_cycles,
