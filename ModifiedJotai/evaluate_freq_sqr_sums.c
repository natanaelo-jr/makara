...
void evaluate_freq_sqr_sums(pair_word_freqs_t *Q, int n,
                            unsigned *sum_sqr_freq_title,
                            unsigned *sum_freq_title_freq_text,
                            unsigned *sum_sqr_freq_text) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_Q0 = 65025;
    struct TYPE_3__ *Q =
        (struct TYPE_3__ *)malloc(_len_Q0 * sizeof(struct TYPE_3__));
    for (int _i0 = 0; _i0 < _len_Q0; _i0++) {
      Q[_i0].freqs = ((-2 * (next_i() % 2)) + 1) * next_i();
    }

    int _len_sum_sqr_freq_title0 = 65025;
    unsigned int *sum_sqr_freq_title =
        (unsigned int *)malloc(_len_sum_sqr_freq_title0 * sizeof(unsigned int));
    ...
    unsigned int *sum_freq_title_freq_text = (unsigned int *)malloc(
        _len_sum_freq_title_freq_text0 * sizeof(unsigned int));
    ...
    unsigned int *sum_sqr_freq_text =
        (unsigned int *)malloc(_len_sum_sqr_freq_text0 * sizeof(unsigned int));
...

    {
      ...
      evaluate_freq_sqr_sums(Q, n, sum_sqr_freq_title, sum_freq_title_freq_text,
                             sum_sqr_freq_text);
      ...
      // Write data
      fprintf(f_csv, "evaluate_freq_sqr_sums,%lu,%lu,%lu,%lu newline",
