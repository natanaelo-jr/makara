...
__attribute__((used)) static void process_param(float *bc, EqParameter *param,
                                                float fs) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    for (int _i0 = 0; _i0 < _len_bc0; _i0++) {
      bc[_i0] = ((-2.0 * (next_i() % 2)) + 1.0) *
                (-16777216.000000 +
                 (float)next_f() / (((float)16777215.000000 /
                                     (16777215.000000 - -16777216.000000))));
    }
    int _len_param0 = 1;
    struct TYPE_3__ *param =
        (struct TYPE_3__ *)malloc(_len_param0 * sizeof(struct TYPE_3__));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "process_param,%lu,%lu,%lu,%lu newline", count_cycles,
