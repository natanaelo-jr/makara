...
__attribute__((used)) static bool xgbe_phy_sfp_verify_eeprom(u8 cc_in, u8 *buf,
                                                             unsigned int len) {
  u8 cc;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(xgbe_phy_sfp_verify_eeprom(cc_in, buf, len)) __perf_ret =
          xgbe_phy_sfp_verify_eeprom(cc_in, buf, len);
      ...
      // Write data
      fprintf(f_csv, "xgbe_phy_sfp_verify_eeprom,%lu,%lu,%lu,%lu newline",
