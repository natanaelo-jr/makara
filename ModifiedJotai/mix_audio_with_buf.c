...
__attribute__((used)) static void mix_audio_with_buf(float *p_out, float *p_in,
                                                     float *buf_in, size_t pos,
                                                     size_t count) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      // Write data
      fprintf(f_csv, "mix_audio_with_buf,%lu,%lu,%lu,%lu newline", count_cycles,
