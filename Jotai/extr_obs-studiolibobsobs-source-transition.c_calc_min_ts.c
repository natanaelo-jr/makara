...
calc_min_ts(obs_source_t *sources[2]) {
  uint64_t min_ts = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    int _len_sources0 = 2;
    struct TYPE_3__ **sources =
        (struct TYPE_3__ **)malloc(_len_sources0 * sizeof(struct TYPE_3__ *));
    for (int _i0 = 0; _i0 < _len_sources0; _i0++) {
      int _len_sources1 = 1;
      sources[_i0] =
          (struct TYPE_3__ *)malloc(_len_sources1 * sizeof(struct TYPE_3__));
      for (int _i1 = 0; _i1 < _len_sources1; _i1++) {
        sources[_i0][_i1].audio_ts = ((-2 * (next_i() % 2)) + 1) * next_i();
        sources[_i0][_i1].audio_pending =
            ((-2 * (next_i() % 2)) + 1) * next_i();
      }
    }
