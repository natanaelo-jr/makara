...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    int _len_label0 = 1;
    struct grub_sun_block *label = (struct grub_sun_block *)malloc(
        _len_label0 * sizeof(struct grub_sun_block));
    ...
    int benchRet = ({
      ...
      __typeof__(grub_sun_is_valid(label)) __perf_ret =
          grub_sun_is_valid(label);
      ...
      // Write data
      fprintf(f_csv, "grub_sun_is_valid,%lu,%lu,%lu,%lu newline", count_cycles,
