...
skl_tplg_fill_pin_dynamic_val(struct skl_module_pin *mpin, u32 pin_count,
                              u32 value) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int value = 10;
    int _len_mpin0 = 100;
    struct skl_module_pin *mpin = (struct skl_module_pin *)malloc(
        _len_mpin0 * sizeof(struct skl_module_pin));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "skl_tplg_fill_pin_dynamic_val,%lu,%lu,%lu,%lu newline",
