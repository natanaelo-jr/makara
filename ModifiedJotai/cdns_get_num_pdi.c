...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct sdw_cdns *cdns =
        (struct sdw_cdns *)malloc(_len_cdns0 * sizeof(struct sdw_cdns));
    ...
    int _len_pdi0 = 65025;
    struct sdw_cdns_pdi *pdi =
        (struct sdw_cdns_pdi *)malloc(_len_pdi0 * sizeof(struct sdw_cdns_pdi));
    ...
    int benchRet = ({
      ...
      __typeof__(cdns_get_num_pdi(cdns, pdi, num, ch_count)) __perf_ret =
          cdns_get_num_pdi(cdns, pdi, num, ch_count);
      ...
      // Write data
      fprintf(f_csv, "cdns_get_num_pdi,%lu,%lu,%lu,%lu newline", count_cycles,
