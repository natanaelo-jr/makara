...
CalcVClock(int clockIn, int *clockOut, u32 *pllOut, struct nvidia_par *par) {
  unsigned lowM, highM;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_pllOut0 = 1;
    unsigned int *pllOut =
        (unsigned int *)malloc(_len_pllOut0 * sizeof(unsigned int));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "CalcVClock,%lu,%lu,%lu,%lu newline", count_cycles,
