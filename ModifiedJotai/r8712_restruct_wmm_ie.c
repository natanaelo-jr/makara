...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(r8712_restruct_wmm_ie(adapter,in_ie,out_ie,in_len,initial_out_len)) __perf_ret = r8712_restruct_wmm_ie(adapter,in_ie,out_ie,in_len,initial_out_len);
