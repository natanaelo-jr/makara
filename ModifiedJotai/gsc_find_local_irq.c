...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(gsc_find_local_irq(irq, global_irqs, limit)) __perf_ret =
          gsc_find_local_irq(irq, global_irqs, limit);
      ...
      // Write data
      fprintf(f_csv, "gsc_find_local_irq,%lu,%lu,%lu,%lu newline", count_cycles,
