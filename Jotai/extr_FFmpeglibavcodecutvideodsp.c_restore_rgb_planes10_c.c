...
restore_rgb_planes10_c(uint16_t *src_r, uint16_t *src_g, uint16_t *src_b,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    restore_rgb_planes10_c(src_r, src_g, src_b, linesize_r, linesize_g,
                           linesize_b, width, height);
    free(src_r);
    free(src_g);
    free(src_b);
