...
get_order_of_qentries(u16 queue_entries) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned int benchRet = ({
      ...
      __typeof__(get_order_of_qentries(queue_entries)) __perf_ret =
          get_order_of_qentries(queue_entries);
      ...
      // Write data
      fprintf(f_csv, "get_order_of_qentries,%lu,%lu,%lu,%lu newline",
