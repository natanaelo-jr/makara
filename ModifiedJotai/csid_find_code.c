...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(csid_find_code(code, n_code, index, req_code)) __perf_ret =
          csid_find_code(code, n_code, index, req_code);
      ...
      // Write data
      fprintf(f_csv, "csid_find_code,%lu,%lu,%lu,%lu newline", count_cycles,
