...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(mpihelp_add_n(res_ptr, s1_ptr, s2_ptr, size)) __perf_ret =
          mpihelp_add_n(res_ptr, s1_ptr, s2_ptr, size);
      ...
      // Write data
      fprintf(f_csv, "mpihelp_add_n,%lu,%lu,%lu,%lu newline", count_cycles,
