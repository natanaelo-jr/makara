...
tegra_bpmp_i2c_msg_len_check(struct i2c_msg *msgs, unsigned int num) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct i2c_msg *msgs =
        (struct i2c_msg *)malloc(_len_msgs0 * sizeof(struct i2c_msg));
    ...
    int benchRet = ({
      ...
      __typeof__(tegra_bpmp_i2c_msg_len_check(msgs, num)) __perf_ret =
          tegra_bpmp_i2c_msg_len_check(msgs, num);
      ...
      // Write data
      fprintf(f_csv, "tegra_bpmp_i2c_msg_len_check,%lu,%lu,%lu,%lu newline",
