...
__attribute__((used)) static inline void clear_chars_in_line(CPUCell *cpu_cells,
                                                             GPUCell *gpu_cells,
                                                             index_type xnum,
                                                             char_type ch) {
  // Clear only the char part of each cell, the rest must have been cleared by a
  // memset or similar
  if (ch) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_6__ *cpu_cells =
        (struct TYPE_6__ *)malloc(_len_cpu_cells0 * sizeof(struct TYPE_6__));
    for (int _i0 = 0; _i0 < _len_cpu_cells0; _i0++) {
      cpu_cells[_i0].ch = ((-2 * (next_i() % 2)) + 1) * next_i();
    }

    int _len_gpu_cells0 = 65025;
    struct TYPE_5__ *gpu_cells =
        (struct TYPE_5__ *)malloc(_len_gpu_cells0 * sizeof(struct TYPE_5__));
...

    {
      ...
      // Write data
      fprintf(f_csv, "clear_chars_in_line,%lu,%lu,%lu,%lu newline",
