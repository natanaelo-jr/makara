...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned int benchRet = ({
      ...
      __typeof__(atc_get_pitch(input_rate, output_rate)) __perf_ret =
          atc_get_pitch(input_rate, output_rate);
      ...
      // Write data
      fprintf(f_csv, "atc_get_pitch,%lu,%lu,%lu,%lu newline", count_cycles,
