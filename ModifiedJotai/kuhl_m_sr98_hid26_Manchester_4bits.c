...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(kuhl_m_sr98_hid26_Manchester_4bits(data4)) __perf_ret = kuhl_m_sr98_hid26_Manchester_4bits(data4);
    ...
    // Write data
    fprintf(f_csv, "kuhl_m_sr98_hid26_Manchester_4bits,%lu,%lu,%lu,%lu newline",
            count_cycles,
            count_instructions,
            count_cache_miss,
            count_cache_ref);
