...
int ff_dca_set_channel_layout(AVCodecContext *avctx, int *ch_remap,
                              int dca_mask) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_3__ *avctx =
        (struct TYPE_3__ *)malloc(_len_avctx0 * sizeof(struct TYPE_3__));
    for (int _i0 = 0; _i0 < _len_avctx0; _i0++) {
      avctx[_i0].request_channel_layout =
          ((-2 * (next_i() % 2)) + 1) * next_i();
