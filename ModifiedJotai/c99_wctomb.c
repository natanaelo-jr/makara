...
__attribute__((used)) static int c99_wctomb(conv_t conv, unsigned char *r,
                                            ucs4_t wc, size_t n) {
  if (wc < 0xa0) {
    *r = wc;
    return 1;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(c99_wctomb(conv, r, wc, n)) __perf_ret =
          c99_wctomb(conv, r, wc, n);
      ...
      // Write data
      fprintf(f_csv, "c99_wctomb,%lu,%lu,%lu,%lu newline", count_cycles,
