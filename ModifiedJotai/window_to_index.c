...
__attribute__((used)) static int window_to_index(HWND hwnd, HWND *window,
                                                 int size) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(window_to_index(hwnd, window, size)) __perf_ret =
          window_to_index(hwnd, window, size);
      ...
      // Write data
      fprintf(f_csv, "window_to_index,%lu,%lu,%lu,%lu newline", count_cycles,
