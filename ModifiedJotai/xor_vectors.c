...
__attribute__((used)) static void xor_vectors(unsigned char *in1,
                                              unsigned char *in2,
                                              unsigned char *out,
                                              unsigned int size) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_in10 = 65025;
    unsigned char *in1 =
        (unsigned char *)malloc(_len_in10 * sizeof(unsigned char));
    ...
    int _len_in20 = 65025;
    unsigned char *in2 =
        (unsigned char *)malloc(_len_in20 * sizeof(unsigned char));
    ...
    int _len_out0 = 65025;
    unsigned char *out =
        (unsigned char *)malloc(_len_out0 * sizeof(unsigned char));
...

    {
      ...
      // Write data
      fprintf(f_csv, "xor_vectors,%lu,%lu,%lu,%lu newline", count_cycles,
