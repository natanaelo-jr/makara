...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      altera_concatenate_data(buffer, preamble_data, preamble_count,
                              target_data, start_index, target_count,
                              postamble_data, postamble_count);
      ...
      // Write data
      fprintf(f_csv, "altera_concatenate_data,%lu,%lu,%lu,%lu newline",
