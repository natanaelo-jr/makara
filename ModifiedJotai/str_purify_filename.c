...
str_purify_filename(char *dst, char *src, size_t size) /* {{{ */
{
  char *d, *end;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *benchRet = ({
      ...
      __typeof__(str_purify_filename(dst, src, size)) __perf_ret =
          str_purify_filename(dst, src, size);
      ...
      // Write data
      fprintf(f_csv, "str_purify_filename,%lu,%lu,%lu,%lu newline",
