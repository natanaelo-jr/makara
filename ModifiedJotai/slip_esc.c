...
__attribute__((used)) static int slip_esc(unsigned char *s, unsigned char *d,
                                          int len) {
  unsigned char *ptr = d;
  unsigned char c;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(slip_esc(s, d, len)) __perf_ret = slip_esc(s, d, len);
      ...
      // Write data
      fprintf(f_csv, "slip_esc,%lu,%lu,%lu,%lu newline", count_cycles,
