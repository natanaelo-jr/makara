...
__attribute__((used)) static inline size_t eir_get_length(u8 *eir,
                                                          size_t eir_len) {
  size_t parsed = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(eir_get_length(eir, eir_len)) __perf_ret =
          eir_get_length(eir, eir_len);
      ...
      // Write data
      fprintf(f_csv, "eir_get_length,%lu,%lu,%lu,%lu newline", count_cycles,
