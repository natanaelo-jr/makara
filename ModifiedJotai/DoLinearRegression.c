...
__attribute__((used)) static ULONG64 DoLinearRegression(ULONG XMax,
                                                        ULONG64 *ArrayY) {
  ULONG X, SumXX;
  ULONG64 SumXY;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(DoLinearRegression(XMax, ArrayY)) __perf_ret =
          DoLinearRegression(XMax, ArrayY);
      ...
      // Write data
      fprintf(f_csv, "DoLinearRegression,%lu,%lu,%lu,%lu newline", count_cycles,
