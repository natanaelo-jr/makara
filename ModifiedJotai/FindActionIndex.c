...
__attribute__((used)) static INT FindActionIndex(POWER_ACTION *lpAction,
                                                 DWORD dwActionSize,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(FindActionIndex(lpAction, dwActionSize, poAction)) __perf_ret =
          FindActionIndex(lpAction, dwActionSize, poAction);
      ...
      // Write data
      fprintf(f_csv, "FindActionIndex,%lu,%lu,%lu,%lu newline", count_cycles,
