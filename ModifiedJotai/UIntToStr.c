...
__attribute__((used)) static char *UIntToStr(char *s, unsigned value,
                                             int numDigits) {
  char temp[16];
  int pos = 0;
  do
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *benchRet = ({
      ...
      __typeof__(UIntToStr(s, value, numDigits)) __perf_ret =
          UIntToStr(s, value, numDigits);
      ...
      // Write data
      fprintf(f_csv, "UIntToStr,%lu,%lu,%lu,%lu newline", count_cycles,
