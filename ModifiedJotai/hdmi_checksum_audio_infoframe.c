...
hdmi_checksum_audio_infoframe(struct hdmi_audio_infoframe *hdmi_ai) {
  u8 *bytes = (u8 *)hdmi_ai;
  u8 sum = 0;
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct hdmi_audio_infoframe *hdmi_ai =
        (struct hdmi_audio_infoframe *)malloc(
            _len_hdmi_ai0 * sizeof(struct hdmi_audio_infoframe));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "hdmi_checksum_audio_infoframe,%lu,%lu,%lu,%lu newline",
