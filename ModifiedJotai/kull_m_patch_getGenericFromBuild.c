...
int main(int argc, char *argv[]) {
    ...
    if (fd_cache_miss == -1) { perror("perf_event_open (cache misses)"); exit(1); }
          ...
          __typeof__(kull_m_patch_getGenericFromBuild(generics,cbGenerics,BuildNumber)) __perf_ret = kull_m_patch_getGenericFromBuild(generics,cbGenerics,BuildNumber);
