...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(mpihelp_sub_n(res_ptr, s1_ptr, s2_ptr, size)) __perf_ret =
          mpihelp_sub_n(res_ptr, s1_ptr, s2_ptr, size);
      ...
      // Write data
      fprintf(f_csv, "mpihelp_sub_n,%lu,%lu,%lu,%lu newline", count_cycles,
