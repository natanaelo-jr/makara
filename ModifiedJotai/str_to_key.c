...
__attribute__((used)) static void str_to_key(unsigned char *str,
                                             unsigned char *key) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    int _len_str0 = 65025;
    unsigned char *str =
        (unsigned char *)malloc(_len_str0 * sizeof(unsigned char));
    ...
    int _len_key0 = 65025;
    unsigned char *key =
        (unsigned char *)malloc(_len_key0 * sizeof(unsigned char));
...

    {
      ...
      // Write data
      fprintf(f_csv, "str_to_key,%lu,%lu,%lu,%lu newline", count_cycles,
