...
struct op_system_config {
  int /*<<< orphan*/ enable_user;
  int /*<<< orphan*/ enable_kernel;
  int /*<<< orphan*/ enable_pal;
};
...
common_reg_setup(struct op_register_config *reg, struct op_counter_config *ctr,
                 struct op_system_config *sys, int cbox1_ofs, int cbox2_ofs) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      // Write data
      fprintf(f_csv, "common_reg_setup,%lu,%lu,%lu,%lu newline", count_cycles,
