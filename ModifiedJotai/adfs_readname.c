...
__attribute__((used)) static inline int adfs_readname(char *buf, char *ptr,
                                                      int maxlen) {
  char *old_buf = buf;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(adfs_readname(buf, ptr, maxlen)) __perf_ret =
          adfs_readname(buf, ptr, maxlen);
      ...
      // Write data
      fprintf(f_csv, "adfs_readname,%lu,%lu,%lu,%lu newline", count_cycles,
