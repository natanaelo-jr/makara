...
pm2v_mnp(u32 clk, unsigned char *mm, unsigned char *nn, unsigned char *pp) {
  unsigned char m;
  unsigned char n;
  unsigned char p;
  u32 f;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_mm0 = 1;
    unsigned char *mm =
        (unsigned char *)malloc(_len_mm0 * sizeof(unsigned char));
    ...
    int _len_nn0 = 1;
    unsigned char *nn =
        (unsigned char *)malloc(_len_nn0 * sizeof(unsigned char));
    ...
    int _len_pp0 = 1;
    unsigned char *pp =
        (unsigned char *)malloc(_len_pp0 * sizeof(unsigned char));
...

    {
      ...
      // Write data
      fprintf(f_csv, "pm2v_mnp,%lu,%lu,%lu,%lu newline", count_cycles,
