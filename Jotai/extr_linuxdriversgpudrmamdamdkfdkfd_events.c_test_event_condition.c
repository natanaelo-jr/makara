...
test_event_condition(bool all, uint32_t num_events,
  ...
  return activated_count == num_events ? KFD_IOC_WAIT_RESULT_COMPLETE
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct kfd_event_waiter *event_waiters = (struct kfd_event_waiter *)malloc(
        _len_event_waiters0 * sizeof(struct kfd_event_waiter));
