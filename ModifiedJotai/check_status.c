...
__attribute__((used)) static void check_status(adns_status st) {
  static const adns_status statuspoints[] = {
      adns_s_ok,           adns_s_max_localfail, adns_s_max_remotefail,
      adns_s_max_tempfail, adns_s_max_misconfig, adns_s_max_misquery};
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    const long st = 100;
    {
      ...
      // Write data
      fprintf(f_csv, "check_status,%lu,%lu,%lu,%lu newline", count_cycles,
