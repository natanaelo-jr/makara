...
__attribute__((used)) static void MaybeByteSwap(char *number, size_t numbersize,
                                                DumpState *D) {
  int x = 1;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_D0 = 65025;
    struct TYPE_5__ *D =
        (struct TYPE_5__ *)malloc(_len_D0 * sizeof(struct TYPE_5__));
...

    {
      ...
      // Write data
      fprintf(f_csv, "MaybeByteSwap,%lu,%lu,%lu,%lu newline", count_cycles,
