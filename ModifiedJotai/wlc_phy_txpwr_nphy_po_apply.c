...
__attribute__((used)) static void wlc_phy_txpwr_nphy_po_apply(u8 *srom_max,
                                                              u8 pwr_offset,
                                                              u8 rate_start,
                                                              u8 rate_end) {
  u8 rate;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long *srom_max =
        (unsigned long *)malloc(_len_srom_max0 * sizeof(unsigned long));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "wlc_phy_txpwr_nphy_po_apply,%lu,%lu,%lu,%lu newline",
