...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_sline0 = 100;
    struct sline *sline =
        (struct sline *)malloc(_len_sline0 * sizeof(struct sline));
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(find_next(sline, mark, i, cnt,
                           look_for_uninteresting)) __perf_ret =
          find_next(sline, mark, i, cnt, look_for_uninteresting);
      ...
      // Write data
      fprintf(f_csv, "find_next,%lu,%lu,%lu,%lu newline", count_cycles,
