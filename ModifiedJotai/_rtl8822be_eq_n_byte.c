...
__attribute__((used)) static bool _rtl8822be_eq_n_byte(u8 *str1, u8 *str2,
                                                       u32 num) {
  if (num == 0)
    return false;
  while (num > 0) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(_rtl8822be_eq_n_byte(str1, str2, num)) __perf_ret =
          _rtl8822be_eq_n_byte(str1, str2, num);
      ...
      // Write data
      fprintf(f_csv, "_rtl8822be_eq_n_byte,%lu,%lu,%lu,%lu newline",
