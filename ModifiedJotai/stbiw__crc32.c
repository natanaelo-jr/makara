...
__attribute__((used)) static unsigned int stbiw__crc32(unsigned char *buffer,
                                                       int len) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned int benchRet = ({
      ...
      __typeof__(stbiw__crc32(buffer, len)) __perf_ret =
          stbiw__crc32(buffer, len);
      ...
      // Write data
      fprintf(f_csv, "stbiw__crc32,%lu,%lu,%lu,%lu newline", count_cycles,
