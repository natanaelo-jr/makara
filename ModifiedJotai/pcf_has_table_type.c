...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_3__ *tables =
        (struct TYPE_3__ *)malloc(_len_tables0 * sizeof(struct TYPE_3__));
    ...
    int benchRet = ({
      ...
      __typeof__(pcf_has_table_type(tables, ntables, type)) __perf_ret =
          pcf_has_table_type(tables, ntables, type);
      ...
      // Write data
      fprintf(f_csv, "pcf_has_table_type,%lu,%lu,%lu,%lu newline", count_cycles,
