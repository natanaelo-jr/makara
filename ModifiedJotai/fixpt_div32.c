...
__attribute__((used)) static int fixpt_div32(u32 dividend, u32 divisor,
                                             u32 *quotient, u32 *fraction) {
  u32 remainder;
  u32 q, f = 0;
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(fixpt_div32(dividend, divisor, quotient,
                             fraction)) __perf_ret =
          fixpt_div32(dividend, divisor, quotient, fraction);
      ...
      // Write data
      fprintf(f_csv, "fixpt_div32,%lu,%lu,%lu,%lu newline", count_cycles,
