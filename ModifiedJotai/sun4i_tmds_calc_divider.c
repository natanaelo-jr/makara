...
sun4i_tmds_calc_divider(unsigned long rate, unsigned long parent_rate,
                        u8 div_offset, u8 *div, bool *half) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(sun4i_tmds_calc_divider(rate, parent_rate, div_offset, div,
                                         half)) __perf_ret =
          sun4i_tmds_calc_divider(rate, parent_rate, div_offset, div, half);
      ...
      // Write data
      fprintf(f_csv, "sun4i_tmds_calc_divider,%lu,%lu,%lu,%lu newline",
