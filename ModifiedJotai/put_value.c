...
__attribute__((used)) static int put_value(unsigned char *data, size_t value,
                                           size_t len) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(put_value(data, value, len)) __perf_ret =
          put_value(data, value, len);
      ...
      // Write data
      fprintf(f_csv, "put_value,%lu,%lu,%lu,%lu newline", count_cycles,
