...
__attribute__((used)) static uint32_t ngx_http_upstream_chash_get_server_index(
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_3__ *servers =
        (struct TYPE_3__ *)malloc(_len_servers0 * sizeof(struct TYPE_3__));
