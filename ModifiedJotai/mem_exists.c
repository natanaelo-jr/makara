...
__attribute__((used)) static BOOL mem_exists(char *buf, int buf_len, char *str,
                                             int str_len) {
  int matches = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(mem_exists(buf, buf_len, str, str_len)) __perf_ret =
          mem_exists(buf, buf_len, str, str_len);
      ...
      // Write data
      fprintf(f_csv, "mem_exists,%lu,%lu,%lu,%lu newline", count_cycles,
