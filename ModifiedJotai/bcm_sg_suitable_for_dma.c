...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct scatterlist *sg_ptr =
        (struct scatterlist *)malloc(_len_sg_ptr0 * sizeof(struct scatterlist));
    ...
    int benchRet = ({
      ...
      __typeof__(bcm_sg_suitable_for_dma(sg_ptr, sg_len)) __perf_ret =
          bcm_sg_suitable_for_dma(sg_ptr, sg_len);
      ...
      // Write data
      fprintf(f_csv, "bcm_sg_suitable_for_dma,%lu,%lu,%lu,%lu newline",
