...
__attribute__((used)) static inline int necp_count_dots(char *string,
                                                        size_t length) {
  int dot_count = 0;
  size_t i = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(necp_count_dots(string, length)) __perf_ret =
          necp_count_dots(string, length);
      ...
      // Write data
      fprintf(f_csv, "necp_count_dots,%lu,%lu,%lu,%lu newline", count_cycles,
