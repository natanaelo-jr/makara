...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(kuhl_m_sr98_hid26_Manchester_4bits(data4)) __perf_ret =
          kuhl_m_sr98_hid26_Manchester_4bits(data4);
      ...
      // Write data
      fprintf(
          f_csv, "kuhl_m_sr98_hid26_Manchester_4bits,%lu,%lu,%lu,%lu newline",
