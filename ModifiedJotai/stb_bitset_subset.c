...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(stb_bitset_subset(bigger, smaller, len)) __perf_ret =
          stb_bitset_subset(bigger, smaller, len);
      ...
      // Write data
      fprintf(f_csv, "stb_bitset_subset,%lu,%lu,%lu,%lu newline", count_cycles,
