...
__attribute__((used)) static int calc_parm_search(int msec, short *table) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(calc_parm_search(msec, table)) __perf_ret =
          calc_parm_search(msec, table);
      ...
      // Write data
      fprintf(f_csv, "calc_parm_search,%lu,%lu,%lu,%lu newline", count_cycles,
