...
octeon_droq_compute_max_packet_bufs(struct octeon_droq *droq) {
  u32 count = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct octeon_droq *droq =
        (struct octeon_droq *)malloc(_len_droq0 * sizeof(struct octeon_droq));
...

    {
      ...
      // Write data
      fprintf(
          f_csv, "octeon_droq_compute_max_packet_bufs,%lu,%lu,%lu,%lu newline",
