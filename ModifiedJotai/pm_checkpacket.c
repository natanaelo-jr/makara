...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned char *packet =
        (unsigned char *)malloc(_len_packet0 * sizeof(unsigned char));
    ...
    int benchRet = ({
      ...
      __typeof__(pm_checkpacket(packet)) __perf_ret = pm_checkpacket(packet);
      ...
      // Write data
      fprintf(f_csv, "pm_checkpacket,%lu,%lu,%lu,%lu newline", count_cycles,
