...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *SettingValueLine =
        (char *)malloc(_len_SettingValueLine0 * sizeof(char));
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(IniGetSettingValueSize(SettingValueLine,
                                        LineLength)) __perf_ret =
          IniGetSettingValueSize(SettingValueLine, LineLength);
      ...
      // Write data
      fprintf(f_csv, "IniGetSettingValueSize,%lu,%lu,%lu,%lu newline",
