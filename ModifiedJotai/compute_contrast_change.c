...
__attribute__((used)) static void compute_contrast_change(float *histogram1,
                                                          float *histogram2,
                                                          unsigned *cchange,
                                                          size_t hsize) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned int *cchange =
        (unsigned int *)malloc(_len_cchange0 * sizeof(unsigned int));
...

    {
      ...
      // Write data
      fprintf(f_csv, "compute_contrast_change,%lu,%lu,%lu,%lu newline",
