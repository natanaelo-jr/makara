...
__attribute__((used)) static int alloc_lpt_leb(struct ubifs_info *c,
                                               int *lnum) {
  int i, n;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    int _len_c0 = 1;
    struct ubifs_info *c =
        (struct ubifs_info *)malloc(_len_c0 * sizeof(struct ubifs_info));
    for (int _i0 = 0; _i0 < _len_c0; _i0++) {
      ...
      c[_i0].ltab = (struct TYPE_2__ *)malloc(_len_c__i0__ltab0 *
                                              sizeof(struct TYPE_2__));
    ...
    int benchRet = ({
      ...
      __typeof__(alloc_lpt_leb(c, lnum)) __perf_ret = alloc_lpt_leb(c, lnum);
      ...
      // Write data
      fprintf(f_csv, "alloc_lpt_leb,%lu,%lu,%lu,%lu newline", count_cycles,
