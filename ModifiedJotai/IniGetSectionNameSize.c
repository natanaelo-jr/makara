...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *SectionNameLine =
        (char *)malloc(_len_SectionNameLine0 * sizeof(char));
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(IniGetSectionNameSize(SectionNameLine,
                                       LineLength)) __perf_ret =
          IniGetSectionNameSize(SectionNameLine, LineLength);
      ...
      // Write data
      fprintf(f_csv, "IniGetSectionNameSize,%lu,%lu,%lu,%lu newline",
