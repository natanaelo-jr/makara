...
ltr501_get_gain_index(struct ltr501_gain *gain, int size, int val, int val2) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct ltr501_gain *gain =
        (struct ltr501_gain *)malloc(_len_gain0 * sizeof(struct ltr501_gain));
    ...
    int benchRet = ({
      ...
      __typeof__(ltr501_get_gain_index(gain, size, val, val2)) __perf_ret =
          ltr501_get_gain_index(gain, size, val, val2);
      ...
      // Write data
      fprintf(f_csv, "ltr501_get_gain_index,%lu,%lu,%lu,%lu newline",
