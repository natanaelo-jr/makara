...
__attribute__((used)) static double power_of_ten(int n) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    double benchRet = ({
      ...
      __typeof__(power_of_ten(n)) __perf_ret = power_of_ten(n);
      ...
      // Write data
      fprintf(f_csv, "power_of_ten,%lu,%lu,%lu,%lu newline", count_cycles,
