...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct adapter *adapter =
        (struct adapter *)malloc(_len_adapter0 * sizeof(struct adapter));
    ...
    int benchRet = ({
      ...
      __typeof__(rtw_restruct_wmm_ie(adapter, in_ie, out_ie, in_len,
                                     initial_out_len)) __perf_ret =
          rtw_restruct_wmm_ie(adapter, in_ie, out_ie, in_len, initial_out_len);
      ...
      // Write data
      fprintf(f_csv, "rtw_restruct_wmm_ie,%lu,%lu,%lu,%lu newline",
