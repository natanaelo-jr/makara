...
freq_table_sort(struct cpufreq_frequency_table *freq_table, int count) {
  int i, j, ind;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
...

    {
      ...
      // Write data
      fprintf(f_csv, "freq_table_sort,%lu,%lu,%lu,%lu newline", count_cycles,
