...
i40iw_check_mem_contiguous(u64 *arr, u32 npages, u32 pg_size) {
  u32 pg_idx;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(i40iw_check_mem_contiguous(arr, npages, pg_size)) __perf_ret =
          i40iw_check_mem_contiguous(arr, npages, pg_size);
      ...
      // Write data
      fprintf(f_csv, "i40iw_check_mem_contiguous,%lu,%lu,%lu,%lu newline",
