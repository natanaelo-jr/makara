...
alps_get_bitmap_points(unsigned int map, struct alps_bitmap_point *low,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_low0 = 1;
    struct alps_bitmap_point *low = (struct alps_bitmap_point *)malloc(
        _len_low0 * sizeof(struct alps_bitmap_point));
    for (int _i0 = 0; _i0 < _len_low0; _i0++) {
      low[_i0].start_bit = ((-2 * (next_i() % 2)) + 1) * next_i();
      low[_i0].num_bits = ((-2 * (next_i() % 2)) + 1) * next_i();
    }
    int _len_high0 = 1;
    struct alps_bitmap_point *high = (struct alps_bitmap_point *)malloc(
        _len_high0 * sizeof(struct alps_bitmap_point));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "alps_get_bitmap_points,%lu,%lu,%lu,%lu newline",
