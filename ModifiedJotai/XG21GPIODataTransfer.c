...
XG21GPIODataTransfer(unsigned char ujDate) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned char benchRet = ({
      ...
      __typeof__(XG21GPIODataTransfer(ujDate)) __perf_ret =
          XG21GPIODataTransfer(ujDate);
      ...
      // Write data
      fprintf(f_csv, "XG21GPIODataTransfer,%lu,%lu,%lu,%lu newline",
