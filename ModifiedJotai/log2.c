...
__attribute__((used)) static inline int log2(vm_offset_t size) {
  int result;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(log2(size)) __perf_ret = log2(size);
      ...
      // Write data
      fprintf(f_csv, "log2,%lu,%lu,%lu,%lu newline", count_cycles,
