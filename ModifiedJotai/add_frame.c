...
__attribute__((used)) static int add_frame(DiracFrame *framelist[],
                                           int maxframes, DiracFrame *frame) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(add_frame(framelist, maxframes, frame)) __perf_ret =
          add_frame(framelist, maxframes, frame);
      ...
      // Write data
      fprintf(f_csv, "add_frame,%lu,%lu,%lu,%lu newline", count_cycles,
