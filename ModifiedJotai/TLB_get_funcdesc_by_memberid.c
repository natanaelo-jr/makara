...
__attribute__((used)) static inline TLBFuncDesc *
TLB_get_funcdesc_by_memberid(TLBFuncDesc *funcdescs, UINT n, MEMBERID memid) {
  while (n) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_6__ *funcdescs =
        (struct TYPE_6__ *)malloc(_len_funcdescs0 * sizeof(struct TYPE_6__));
    for (int _i0 = 0; _i0 < _len_funcdescs0; _i0++) {
      funcdescs[_i0].funcdesc.memid = ((-2 * (next_i() % 2)) + 1) * next_i();
    }
    struct TYPE_6__ *benchRet = ({
      ...
      __typeof__(TLB_get_funcdesc_by_memberid(funcdescs, n, memid)) __perf_ret =
          TLB_get_funcdesc_by_memberid(funcdescs, n, memid);
      ...
      // Write data
      fprintf(f_csv, "TLB_get_funcdesc_by_memberid,%lu,%lu,%lu,%lu newline",
