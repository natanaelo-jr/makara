...
__attribute__((used)) static int nodeid_warned(int nodeid, int num_nodes,
                                               int *warned) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(nodeid_warned(nodeid, num_nodes, warned)) __perf_ret =
          nodeid_warned(nodeid, num_nodes, warned);
      ...
      // Write data
      fprintf(f_csv, "nodeid_warned,%lu,%lu,%lu,%lu newline", count_cycles,
