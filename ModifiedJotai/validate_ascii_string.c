...
__attribute__((used)) static bool validate_ascii_string(efi_char16_t *var_name,
                                                        int match, u8 *buffer,
                                                        unsigned long len) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(validate_ascii_string(var_name, match, buffer,
                                       len)) __perf_ret =
          validate_ascii_string(var_name, match, buffer, len);
      ...
      // Write data
      fprintf(f_csv, "validate_ascii_string,%lu,%lu,%lu,%lu newline",
