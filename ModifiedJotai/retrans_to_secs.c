...
__attribute__((used)) static int retrans_to_secs(u8 retrans, int timeout,
                                                 int rto_max) {
  int period = 0;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(retrans_to_secs(retrans, timeout, rto_max)) __perf_ret =
          retrans_to_secs(retrans, timeout, rto_max);
      ...
      // Write data
      fprintf(f_csv, "retrans_to_secs,%lu,%lu,%lu,%lu newline", count_cycles,
