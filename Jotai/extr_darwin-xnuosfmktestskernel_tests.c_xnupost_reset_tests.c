...
struct TYPE_3__ {
  int xt_retval;
  int /*<<< orphan*/ xt_test_actions;
  scalar_t__ xt_end_time;
  scalar_t__ xt_begin_time;
};
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_3__ *test_list =
        (struct TYPE_3__ *)malloc(_len_test_list0 * sizeof(struct TYPE_3__));
