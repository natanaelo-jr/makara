...
__attribute__((used)) static int board_id_in_array(u32 a[], int nelems,
                                                   u32 board_id) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(board_id_in_array(a, nelems, board_id)) __perf_ret =
          board_id_in_array(a, nelems, board_id);
      ...
      // Write data
      fprintf(f_csv, "board_id_in_array,%lu,%lu,%lu,%lu newline", count_cycles,
