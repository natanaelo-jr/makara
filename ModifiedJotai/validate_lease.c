...
validate_lease(struct drm_device *dev, struct drm_file *lessor_priv,
               int object_count, struct drm_mode_object **objects) {
  int o;
  int has_crtc = -1;
  int has_connector = -1;
  int has_plane = -1;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct drm_device *dev =
        (struct drm_device *)malloc(_len_dev0 * sizeof(struct drm_device));
    ...
    struct drm_file *lessor_priv =
        (struct drm_file *)malloc(_len_lessor_priv0 * sizeof(struct drm_file));
    for (int _i0 = 0; _i0 < _len_lessor_priv0; _i0++) {
      lessor_priv[_i0].universal_planes =
          ((-2 * (next_i() % 2)) + 1) * next_i();
    }

    int _len_objects0 = 65025;
    struct drm_mode_object **objects = (struct drm_mode_object **)malloc(
        _len_objects0 * sizeof(struct drm_mode_object *));
    for (int _i0 = 0; _i0 < _len_objects0; _i0++) {
      int _len_objects1 = 1;
      objects[_i0] = (struct drm_mode_object *)malloc(
          _len_objects1 * sizeof(struct drm_mode_object));
    ...
    int benchRet = ({
      ...
      __typeof__(validate_lease(dev, lessor_priv, object_count,
                                objects)) __perf_ret =
          validate_lease(dev, lessor_priv, object_count, objects);
      ...
      // Write data
      fprintf(f_csv, "validate_lease,%lu,%lu,%lu,%lu newline", count_cycles,
