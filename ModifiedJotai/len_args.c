...
__attribute__((used)) static unsigned len_args(unsigned numargs,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_args0 = 100;
    struct fuse_arg *args =
        (struct fuse_arg *)malloc(_len_args0 * sizeof(struct fuse_arg));
    ...
    unsigned int benchRet = ({
      ...
      __typeof__(len_args(numargs, args)) __perf_ret = len_args(numargs, args);
      ...
      // Write data
      fprintf(f_csv, "len_args,%lu,%lu,%lu,%lu newline", count_cycles,
