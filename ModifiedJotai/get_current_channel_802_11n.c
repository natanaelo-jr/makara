...
__attribute__((used)) static u8 get_current_channel_802_11n(u8 *msa,
                                                            u16 rx_len) {
  u16 index;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    long benchRet = ({
      ...
      __typeof__(get_current_channel_802_11n(msa, rx_len)) __perf_ret =
          get_current_channel_802_11n(msa, rx_len);
      ...
      // Write data
      fprintf(f_csv, "get_current_channel_802_11n,%lu,%lu,%lu,%lu newline",
