...
__attribute__((used)) static u8 wbcir_to_rc6cells(u8 val) {
  u8 coded = 0x00;
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(wbcir_to_rc6cells(val)) __perf_ret = wbcir_to_rc6cells(val);
      ...
      // Write data
      fprintf(f_csv, "wbcir_to_rc6cells,%lu,%lu,%lu,%lu newline", count_cycles,
