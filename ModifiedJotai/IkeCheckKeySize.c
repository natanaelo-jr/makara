...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_c0 = 1;
    struct TYPE_3__ *c =
        (struct TYPE_3__ *)malloc(_len_c0 * sizeof(struct TYPE_3__));
    ...
    int benchRet = ({
      ...
      __typeof__(IkeCheckKeySize(c, size)) __perf_ret =
          IkeCheckKeySize(c, size);
      ...
      // Write data
      fprintf(f_csv, "IkeCheckKeySize,%lu,%lu,%lu,%lu newline", count_cycles,
