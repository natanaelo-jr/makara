...
__attribute__((used)) static u16 cellrate_to_float(u32 cr) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(cellrate_to_float(cr)) __perf_ret = cellrate_to_float(cr);
      ...
      // Write data
      fprintf(f_csv, "cellrate_to_float,%lu,%lu,%lu,%lu newline", count_cycles,
