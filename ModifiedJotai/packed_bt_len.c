...
__attribute__((used)) static int packed_bt_len(struct backtrace_location *bt,
                                               int n) {
  int len = 0;
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_bt0 = 65025;
    struct backtrace_location *bt = (struct backtrace_location *)malloc(
        _len_bt0 * sizeof(struct backtrace_location));
    ...
    int benchRet = ({
      ...
      __typeof__(packed_bt_len(bt, n)) __perf_ret = packed_bt_len(bt, n);
      ...
      // Write data
      fprintf(f_csv, "packed_bt_len,%lu,%lu,%lu,%lu newline", count_cycles,
