...
__attribute__((used)) static int compare_oid(unsigned long *oid1,
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    unsigned long *oid1 =
        (unsigned long *)malloc(_len_oid10 * sizeof(unsigned long));
    ...
    unsigned long *oid2 =
        (unsigned long *)malloc(_len_oid20 * sizeof(unsigned long));
    ...
    int benchRet = ({
      ...
      __typeof__(compare_oid(oid1, oid1len, oid2, oid2len)) __perf_ret =
          compare_oid(oid1, oid1len, oid2, oid2len);
      ...
      // Write data
      fprintf(f_csv, "compare_oid,%lu,%lu,%lu,%lu newline", count_cycles,
