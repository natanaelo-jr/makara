...
__attribute__((used)) static inline ole_priv_data_entry *
find_format_in_list(ole_priv_data_entry *entries, DWORD num, UINT cf) {
  DWORD i;
  for (i = 0; i < num; i++)
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct TYPE_6__ *entries =
        (struct TYPE_6__ *)malloc(_len_entries0 * sizeof(struct TYPE_6__));
    ...
    struct TYPE_6__ *benchRet = ({
      ...
      __typeof__(find_format_in_list(entries, num, cf)) __perf_ret =
          find_format_in_list(entries, num, cf);
      ...
      // Write data
      fprintf(f_csv, "find_format_in_list,%lu,%lu,%lu,%lu newline",
