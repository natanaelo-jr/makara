...
__attribute__((used)) static u16 sunxi_nfc_randomizer_step(u16 state,
                                                           int count) {
  state &= 0x7fff;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(sunxi_nfc_randomizer_step(state, count)) __perf_ret =
          sunxi_nfc_randomizer_step(state, count);
      ...
      // Write data
      fprintf(f_csv, "sunxi_nfc_randomizer_step,%lu,%lu,%lu,%lu newline",
