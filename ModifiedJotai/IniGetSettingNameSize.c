...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    char *SettingNameLine =
        (char *)malloc(_len_SettingNameLine0 * sizeof(char));
    ...
    unsigned long benchRet = ({
      ...
      __typeof__(IniGetSettingNameSize(SettingNameLine,
                                       LineLength)) __perf_ret =
          IniGetSettingNameSize(SettingNameLine, LineLength);
      ...
      // Write data
      fprintf(f_csv, "IniGetSettingNameSize,%lu,%lu,%lu,%lu newline",
