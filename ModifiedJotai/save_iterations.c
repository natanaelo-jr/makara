...
save_iterations(struct iterations *iter, struct branch_entry *be, int nr) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    struct iterations *iter =
        (struct iterations *)malloc(_len_iter0 * sizeof(struct iterations));
    ...
    struct branch_entry *be =
        (struct branch_entry *)malloc(_len_be0 * sizeof(struct branch_entry));
...

    {
      ...
      // Write data
      fprintf(f_csv, "save_iterations,%lu,%lu,%lu,%lu newline", count_cycles,
