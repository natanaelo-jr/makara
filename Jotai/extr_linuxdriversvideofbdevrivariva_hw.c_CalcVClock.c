...
struct TYPE_3__ {
  int CrystalFreqKHz;
  scalar_t__ Architecture;
  unsigned int MaxVClockFreqKHz;
};
...
__attribute__((used)) static int CalcVClock(int clockIn, int *clockOut,
                                            int *mOut, int *nOut, int *pOut,
                                            RIVA_HW_INST *chip) {
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_chip0 = 1;
    struct TYPE_3__ *chip =
        (struct TYPE_3__ *)malloc(_len_chip0 * sizeof(struct TYPE_3__));
