...
__attribute__((used)) static int dt2814_ns_to_timer(unsigned int *ns,
                                                    unsigned int flags) {
  int i;
  unsigned int f;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int benchRet = ({
      ...
      __typeof__(dt2814_ns_to_timer(ns, flags)) __perf_ret =
          dt2814_ns_to_timer(ns, flags);
      ...
      // Write data
      fprintf(f_csv, "dt2814_ns_to_timer,%lu,%lu,%lu,%lu newline", count_cycles,
