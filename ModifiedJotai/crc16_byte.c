...
__attribute__((used)) static void crc16_byte(unsigned int *crc,
                                             unsigned char db) {
  int i;
...
int main(int argc, char *argv[]) {
  ...
  case 0: {
    ...
    int _len_crc0 = 1;
    unsigned int *crc =
        (unsigned int *)malloc(_len_crc0 * sizeof(unsigned int));
    ...
    }
    {
      ...
      // Write data
      fprintf(f_csv, "crc16_byte,%lu,%lu,%lu,%lu newline", count_cycles,
